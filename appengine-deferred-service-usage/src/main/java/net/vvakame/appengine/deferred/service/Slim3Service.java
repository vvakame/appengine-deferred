package net.vvakame.appengine.deferred.service;

import java.util.List;

import org.slim3.datastore.Datastore;
import net.vvakame.appengine.deferred.model.Slim3Model;
import net.vvakame.appengine.deferred.meta.Slim3ModelMeta;
